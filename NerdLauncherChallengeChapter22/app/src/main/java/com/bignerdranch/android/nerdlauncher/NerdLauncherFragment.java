...
public class NerdLauncherFragment extends Fragment {
    ...
    private class ActivityHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ActivityHolder(View itemView) {
            super(itemView);
            mNameTextView = (TextView) itemView.findViewById(R.id.text_app_name);
            mAppImageView = (ImageView) itemView.findViewById(R.id.image_app_icon);
        ...
        public void bindActivity(ResolveInfo resolveInfo) {
            ...
            Drawable appDrawable = mResolveInfo.loadIcon(packageManager);
            mAppImageView.setImageDrawable(appDrawable);
        }
